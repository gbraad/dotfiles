...
# dotfiles
alias goenv='${CONTAINER_RUNTIME} run -it --cap-add=NET_ADMIN --cap-add=NET_RAW --device=/dev/net/tun --rm -v $HOME/Projects:/home/${USER}/Projects --userns=keep-id:uid=$UID,gid=$GID --entrypoint="" ghcr.io/gbraad-devenv/ubi8-gotoolset/base:${GO_VERSION} /bin/zsh'
